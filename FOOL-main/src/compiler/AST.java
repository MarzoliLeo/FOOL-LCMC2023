...
public class AST {
    ...
    public static class FieldNode extends DecNode {
        ...
        final String id;
        int offset; //Ottimizzazione-2 48/51.
    ...
    public static class MethodNode extends DecNode {
        ...
        MethodNode(String id, TypeNode retType, List<ParNode> parametersList, List<DecNode> declarationsList, Node expression) {
            this.id = id;
            this.retType = retType;
            this.parametersList = parametersList;
            this.declarationsList = declarationsList;
            this.expression = expression;
            this.type = new ArrowTypeNode(this.parametersList.stream().map(ParNode::getType).collect(Collectors.toList()), this.retType);
        }
